...
const double g=9.8, KHertz=1.0e4;
...
int main(){
  ...
  double theta; double V0=sqrt(kT/m0),omega0=3*M_PI;//sqrt(kT/m0);
  ...
  int Ncuadros=1000; double t,tdibujo,dt=1e-3,tmax=Lx/V0,tcuadro=8*tmax/Ncuadros; 
