...
for directory in directories:
    ...
    presion_min, presion_max = -0.6,0.6  # Rango para la presión (eje de color
    ...
    try:
        ...
        # Guardar el GIF, cada imagen se mostrará durante 0.5 segundos
        imageio.mimsave(gif_filename, images, duration=5, loop=0)
